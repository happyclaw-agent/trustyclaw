...
class TestReviewData:
    ...
    def test_serialization_roundtrip(self):
        ...
        original = ReviewData(
            ...
            provider="provider-addr-1234567890abcdef",
            renter="renter-addr-1234567890abcdef12",
...
class TestReputationPDAProgram:
    ...
    def program(self):
        ...
        with patch('trustyclaw.sdk.reputation_chain.HAS_SOLANA', False):
            from trustyclaw.sdk.reputation_chain import ReputationPDAProgram
...
class TestReputationError:
    ...
    def test_raise_error(self):
        ...
        from trustyclaw.sdk.reputation_chain import ReputationError
