...
class TestSolanaIntegration(unittest.TestCase):
    ...
    def test_solana_client_creation(self):
        ...
        from trustyclaw.sdk.solana import Network, get_client
    ...
    def test_get_balance(self):
        ...
        from trustyclaw.sdk.solana import WalletInfo, get_client
...
class TestEscrowIntegration(unittest.TestCase):
    ...
    def test_escrow_lifecycle(self):
        ...
        from trustyclaw.sdk.escrow_contract import EscrowState, get_escrow_client
...
class TestReviewIntegration(unittest.TestCase):
    ...
    def test_review_submission(self):
        ...
        from trustyclaw.sdk.review_system import ReviewStatus, get_review_service
